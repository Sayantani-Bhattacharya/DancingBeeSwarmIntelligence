...
class BeeSimEnv(gym.Env):
    def __init__(self, arena_length, arena_width, num_sheep, num_sheepdogs, num_bees, num_sources,
        ...
        Args:
            ...
            goal_point (List[float]): Nectar/Pollen Source points for the bee swarm to reach [x, y] ------------------------- NEed to make it list of lists -> not used currently.
        ...
        # Environment parameters: these are hardcoded parameters that define the environment configuration
        self.bee_ratio = 0.25 # ratio of forger bees to resting bees
        self.num_forger_bees = int(self.num_bees * self.bee_ratio) # number of forger bees
        self.num_resting_bees = self.num_bees - self.num_forger_bees # number of resting bees
        ...
        # # Set goal point parameters for the bee swarm.
        # self.goal_tolreance = 2.5 # accepatable tolerance for the bee to be considered at the source point 
